...
public class RetrievingIndivitualDataFromDatabase {
	...
	public static void main(String[] args) throws Exception {
		...
		String query = "SELECT * FROM primary_person WHERE first_name = 'Ali'";
		...
		System.out.println(id + " " + firstName + " " + lastName + " " + gender + " " + email + " " + dob + " " + employment + " " + martialStatus);
